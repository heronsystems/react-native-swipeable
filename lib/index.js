...
var Swipeable = function (_PureComponent) {
  ...
  function Swipeable(props) {
    ...
    _this._handlePan = _reactNative.Animated.event([null, {
    ...
    var onPanAnimatedValueRef = props.onPanAnimatedValueRef,
        onRef = props.onRef;


    onRef(_this);
    onPanAnimatedValueRef(_this.state.pan);
    return _this;
  }
  ...
  _createClass(Swipeable, [{
    ...
    value: function _hasLeftButtons() {
      var _props = this.props,
          leftButtons = _props.leftButtons,
    ...
    value: function _hasRightButtons() {
      var _props2 = this.props,
          ...
          rightContent = _props2.rightContent;
    ...
    value: function _getReleaseAnimationFn() {
      var _props3 = this.props,
          leftActionReleaseAnimationFn = _props3.leftActionReleaseAnimationFn,
          leftButtonsOpenReleaseAnimationFn = _props3.leftButtonsOpenReleaseAnimationFn,
          leftButtonsCloseReleaseAnimationFn = _props3.leftButtonsCloseReleaseAnimationFn,
          rightActionReleaseAnimationFn = _props3.rightActionReleaseAnimationFn,
          rightButtonsOpenReleaseAnimationFn = _props3.rightButtonsOpenReleaseAnimationFn,
          rightButtonsCloseReleaseAnimationFn = _props3.rightButtonsCloseReleaseAnimationFn,
          swipeReleaseAnimationFn = _props3.swipeReleaseAnimationFn;
    ...
    value: function _getReleaseAnimationConfig() {
      var _props4 = this.props,
          leftActionReleaseAnimationConfig = _props4.leftActionReleaseAnimationConfig,
          leftButtons = _props4.leftButtons,
          leftButtonsOpenReleaseAnimationConfig = _props4.leftButtonsOpenReleaseAnimationConfig,
          leftButtonsCloseReleaseAnimationConfig = _props4.leftButtonsCloseReleaseAnimationConfig,
          leftButtonWidth = _props4.leftButtonWidth,
          rightActionReleaseAnimationConfig = _props4.rightActionReleaseAnimationConfig,
          rightButtons = _props4.rightButtons,
          rightButtonsOpenReleaseAnimationConfig = _props4.rightButtonsOpenReleaseAnimationConfig,
          rightButtonsCloseReleaseAnimationConfig = _props4.rightButtonsCloseReleaseAnimationConfig,
          rightButtonWidth = _props4.rightButtonWidth,
          swipeReleaseAnimationConfig = _props4.swipeReleaseAnimationConfig;
    ...
    value: function _renderButtons(buttons, isLeftButtons) {
      var _props5 = this.props,
          leftButtonContainerStyle = _props5.leftButtonContainerStyle,
          rightButtonContainerStyle = _props5.rightButtonContainerStyle;
    ...
    value: function render() {
      var _props6 = this.props,
          ...
          contentContainerStyle = _props6.contentContainerStyle,
          leftButtons = _props6.leftButtons,
          leftContainerStyle = _props6.leftContainerStyle,
          leftContent = _props6.leftContent,
          rightButtons = _props6.rightButtons,
          rightContainerStyle = _props6.rightContainerStyle,
          rightContent = _props6.rightContent,
          style = _props6.style,
          props = _objectWithoutProperties(_props6, ['children', 'contentContainerStyle', 'leftButtons', 'leftContainerStyle', 'leftContent', 'rightButtons', 'rightContainerStyle', 'rightContent', 'style']);
